...
> **Status:** the MVP is feature-complete, the six domain packs of Phase 19 have landed, and the
> post-MVP sequence of `PLAN.md` § 7 is under way. What each phase delivered, and what changed
> since, is in [`CHANGELOG.md`](CHANGELOG.md).
