...
//! a Claude Code or Codex CLI login already on this machine, an API key
//! aimed at Anthropic, and a Google AI Studio key for Gemini (Grok reuses
//! [`openai`] after a token refresh). Because the boundary is this trait,
//! those paths do not reopen `agent/turn.rs`.
//!
