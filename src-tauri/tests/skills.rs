...
fn the_catalog_is_listable_and_carries_no_step_of_any_runbook() {
    ...
    assert_eq!(
        ...
        vec![
            ...
            skills::REVIEW_SKILL,
            skills::REPLY_SKILL,
            skills::REVENUE_PIPELINE_SKILL,
            skills::REVENUE_THESIS_SKILL,
            skills::REVIEW_DIFF_SKILL,
            skills::SOCIAL_POST_SKILL,
            skills::SOCIAL_REPLY_SKILL,
            skills::SOCIAL_SCAN_SKILL,
            skills::THREAD_SKILL,
            skills::WATCH_DIGEST_SKILL,
            skills::WATCH_IMPACT_SKILL,
            skills::WATCH_SWEEP_SKILL,
            skills::WISH_LIST_SKILL,
            skills::CHECK_SKILL,
            skills::DRAFT_SKILL,
