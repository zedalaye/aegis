...
have the slices § 7.10–7.24 (§ 7.23 in part), § 7.26 in part, and `world/` (§ 7.2). New work is
proposed as a section of `PLAN.md` § 7 before it is coded: what it settles, what it refuses, its
exit.
